    ...
    return (
        <div>
          ...
          <div className="navbar-container">
            <Link to="/" className="navbar-logo"> BISI <i className="fab fa-typo3"></i> </Link>
            ...
            <ul className={click? "nav-menu active": "nav-menu"}>
                ...
                <li className="nav-links-mobile">  <Link to={"/signup"} className="nav-links" onClick={closeMobileMenu}> Sign Up</Link> </li>
            </ul>
